...
if __name__ == "__main__":
    with open('input.txt') as num_recipes_for_improvement:
        num_recipes_for_improvement =\
            int(num_recipes_for_improvement.read().strip())

        scores = list(
            itertools.islice(
                gen_scores(2, [3, 7]),
                num_recipes_for_improvement, 10 + num_recipes_for_improvement))
